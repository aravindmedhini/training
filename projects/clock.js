...
function newsettime(){
        ...
        if(a==hrs)
        {
            ...
            document.querySelector("#right-inner2").style.backgroundImage="url(./reddy/wakeupimg.png)";
        }
        if(b==hrs)
        {
            document.querySelector("#right-inner1").innerText="Let's Have Some Food";
            document.querySelector("#right-inner2").style.backgroundImage="url(./reddy/letshavesomelunch.png)";
        }
        if(c==hrs)
        {
            document.querySelector("#right-inner1").innerText="Let's Go For Sleep";
            document.querySelector("#right-inner2").style.backgroundImage="url(./reddy/goodnightimage.png)";
        }
}
